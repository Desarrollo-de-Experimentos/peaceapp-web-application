    ...
    return (
        <div className="text-left mb-4 relative" style={{width: "100%"}}>
            <input
                ...
                value={value}
                onChange={onChange}
                className="w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:ring-2 focus:ring-blue-300"
